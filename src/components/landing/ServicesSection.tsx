    ...
    <section id="services" className="py-12 sm:py-16 lg:py-20 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-gradient-card rounded-2xl p-6 sm:p-8 shadow-custom-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button 
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-primary text-primary-foreground rounded-lg font-semibold hover:shadow-custom-md transition-all duration-300 text-sm sm:text-base"
              >
                Request Demo
              </button>
              <button 
                onClick={() => document.querySelector('#pricing')?.scrollIntoView({ behavior: 'smooth' })}
                className="px-6 sm:px-8 py-2.5 sm:py-3 border border-primary text-primary rounded-lg font-semibold hover:bg-primary hover:text-primary-foreground transition-all duration-300 text-sm sm:text-base"
              >
                View Pricing
              </button>
            </div>
