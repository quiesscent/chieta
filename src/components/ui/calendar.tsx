...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row sm:flex-wrap w-full h-[50%] gap-4", // allow wrapping
        month: "flex-1 space-y-4 min-w-[250px]", // each month expands
        ...
        day_today: "bg-green-400 text-white",
        day_outside:
